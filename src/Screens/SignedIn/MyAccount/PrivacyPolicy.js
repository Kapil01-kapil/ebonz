...
const {colors}=this.props;
    ...
    <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
      ...
      <Text style={{fontSize:14,fontWeight:'bold'}}>INTRODUCTION </Text>
    <Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}>EbonZ (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website ebonz.in [and our mobile application], including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</Text>  
 
    <Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}>We reserve the right to make changes to this Privacy Policy at any time and for any reason. We will alert you about any changes by updating the “Last Updated” date of this Privacy Policy. Any changes or modifications will be effective immediately upon posting the updated Privacy Policy on the Site, and you waive the right to receive specific notice of each such change or modification.  </Text> 
  
    <Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}>You are encouraged to periodically review this Privacy Policy to stay informed of updates. You will be deemed to have been made aware of, will be subject to, and will be deemed to have accepted the changes in any revised Privacy Policy by your continued use of the Site after the date such revised Privacy Policy is posted. </Text>
    </View>

    <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
      <Text style={{fontSize:14,fontWeight:'bold'}}>COLLECTION OF YOUR INFORMATION  </Text>
<Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}>We may collect information about you in a variety of ways. The information we may collect on the Site includes:</Text> 
<Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}>We may collect information about you in a variety of ways. The information we may collect on the Site includes:</Text>   
</View>
<View>
<View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
<Text style={{fontSize:14,fontWeight:'bold'}}> Personal Data</Text>
 <Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}> Personally identifiable information, such as your name, shipping address, email address, and telephone number, and demographic information, such as your age, gender, hometown, and interests, that you voluntarily give to us [when you register with the Site [or our mobile application,] or] when you choose to participate in various activities related to the Site [and our mobile application], such as online chat and message boards. You are under no obligation to provide us with personal information of any kind, however your refusal to do so may prevent you from using certain features of the Site [and our mobile application]. </Text>
 </View>
 
 <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
 <Text style={{fontSize:14,fontWeight:'bold'}}>Derivative Data </Text>
  <Text style={{marginVertical:5,color:colors.FOREGROUND_DARK}}> Information our servers automatically collect when you access the Site, such as your IP address, your browser type, your operating system, your access times, and the pages you have viewed directly before and after accessing the Site. [If you are using our mobile application, this information may also include your device name and type, your operating system, your phone number, your country, your likes and replies to a post, and other interactions with the application and other users via server log files, as well as any other information you choose to provide.] 
  </Text>
  </View>
    

 <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
 <Text style={{fontSize:14,fontWeight:'bold'}}>Facebook Permissions</Text>
 <Text>The Site [and our mobile application] may by default access your Facebook basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to make public. We may also request access to other permissions related to your account, such as friends, checkins, and likes, and you may choose to grant or deny us access to each individual permission. For more information regarding Facebook permissions, refer to the Facebook Permissions Reference page. </Text></View>

 <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
 <Text style={{fontSize:14,fontWeight:'bold'}}>  
 Data From Social Networks</Text><Text> User information from social networking sites, such as [Apple’s Game Center, Facebook, Google+, Instagram, Pinterest, Twitter], including your name, your social network username, location, gender, birth date, email address, profile picture, and public data for contacts, if you connect your account to such social networks. [If you are using our mobile application, this information may also include the contact information of anyone you invite to use and/or join our mobile application.] </Text>
 </View>
 <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
 <Text style={{fontSize:14,fontWeight:'bold'}}>
 Mobile Device Data </Text>
 <Text> Device information, such as your mobile device ID, model, and manufacturer, and information about the location of your device, if you access the Site from a mobile device. </Text></View>
 <View style={{marginVertical:5,borderBottomWidth:1,marginBottom:10,borderColor:colors.FOREGROUND_DARK}}>
   <Text style={{fontSize:14,fontWeight:'bold'}}>Third-Party Data </Text>
 <Text> Information from third parties, such as personal information or network friends, if you connect your account to the third party and grant the Site permission to access this information. </Text>
 </View>
 ...
 <Text> We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our mobile application, to provide location-based services. If you wish to change our access or permissions, you may do so in your device’s settings.
   </Text> 
   ...
   <Text> We may request access or permission to certain features from your mobile device, including your mobile device’s [bluetooth, calendar, camera, contacts, microphone, reminders, sensors, SMS messages, social media accounts, storage,] and other features. If you wish to change our access or permissions, you may do so in your device’s settings.</Text> 
    <Text> Mobile Device Data. We may collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and IP address. </Text>
    <Text> Push Notifications. We may request to send you push notifications regarding your account or the Application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings. 
 </Text>
 </View>
 ...
 ● Administer sweepstakes, promotions, and contests.  ● Assist law enforcement and respond to subpoena. ● Compile anonymous statistical data and analysis for use internally or with third parties.  ● Create and manage your account. 
 
  
  
 ● Deliver targeted advertising, coupons, newsletters, and other information regarding promotions and the Site [and our mobile application] to you.  ● Email you regarding your account or order. ● Enable user-to-user communications. ● Fulfill and manage purchases, orders, payments, and other transactions related to the Site [and our mobile application]. ● Generate a personal profile about you to make future visits to the Site [and our mobile application] more personalized. ● Increase the efficiency and operation of the Site [and our mobile application]. ● Monitor and analyze usage and trends to improve your experience with the Site [and our mobile application]. ● Notify you of updates to the Site [and our mobile application]s. ● Offer new products, services, [mobile applications,] and/or recommendations to you. ● Perform other business activities as needed. ● Prevent fraudulent transactions, monitor against theft, and protect against criminal activity. ● Process payments and refunds. ● Request feedback and contact you about your use of the Site [and our mobile application] .  ● Resolve disputes and troubleshoot problems. ● Respond to product and customer service requests. ● Send you a newsletter. ● Solicit support for the Site [and our mobile application]. ● [Other] 
 ...
 Third-Party Advertisers  We may use third-party advertising companies to serve ads when you visit the Site [or our mobile application]. These companies may use information about your visits to the Site [and our mobile application] and other websites that are contained in web cookies 
 ...
 Cookies and Web Beacons [We may use cookies, web beacons, tracking pixels, and other tracking technologies on the Site [and our mobile application] to help customize the Site [and our mobile application] and improve your experience. When you access the Site [or our mobile application], your personal information is not collected through the use of tracking technology. Most browsers are set to accept cookies by default. You can remove or reject cookies, but be aware that such action could affect the availability and functionality of the Site [or our mobile application]. You may not decline web beacons. However, they can be rendered ineffective by declining all cookies or by modifying your web browser’s settings to notify you each time a cookie is tendered, permitting you to accept or decline cookies on an individual basis.] 
  
 [We may use cookies, web beacons, tracking pixels, and other tracking technologies on the Site [and our mobile application] to help customize the Site [and our mobile application] and improve your experience. For more information on how we use cookies, please refer to our Cookie Policy posted on the Site, which is incorporated into this 
 ...
 Emails and Communications If you no longer wish to receive correspondence, emails, or other communications from 
 
  
  
 us, you may opt-out by: ● Noting your preferences at the time you register your account with the Site [or our mobile application] ● Logging into your account settings and updating your preferences. ● Contacting us using the contact information provided below If you no longer wish to receive correspondence, emails, or other communications from third parties, you are responsible for contacting the third party directly.  
