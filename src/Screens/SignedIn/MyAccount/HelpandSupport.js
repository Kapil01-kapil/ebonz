...
import {AppRegistry,Clipboard,ToastAndroid,AlertIOS} from 'react-native';
...
onCancel() {
  ...
  onRate(){
    if (Platform.OS != 'ios') {
      Linking.openURL(`market://details?id=com.ebon.in`).catch(err =>
  ...
  render() {
    ...
    let shareOptions = {
        title: "Share",
        message: "hello",
        url: "Hey check out my app at: https://play.google.com/store/apps/details?id=com.ebon.in",
        subject: "Share Link" 
      };
    ...
    return (
          ...
          {/* <Header  Text='Help and Support' nav={this.props.navigation} backscreen="MyAccount" />  */}

            <TouchableOpacity onPress={()=>this.FAQ()}  >
            <View style={styles.view4} >
            <View style={styles.view5}>
            <Text  style={{color:colors.FOREGROUND_DARK}}  >Get help</Text>
            ...
            <View style={styles.view4} >
            <View style={styles.view5}>
            <Text  style={{color:colors.FOREGROUND_DARK}}  >Rate us</Text>
            ...
            <View style={styles.view4} >
            <View style={styles.view5}>
            <Text  style={{color:colors.FOREGROUND_DARK}}>Invite friends to Ebonz</Text>
            <Text>Invite your friends to buy and sell</Text>
            </View>
            <Image source={Images.next} style={styles.img1}/>
            </View>
            </TouchableOpacity>  
            <TouchableOpacity onPress={()=>Linking.openURL("https://ebonz.in/termsconditions")}>
            <View style={styles.view4} >
            <View style={styles.view5}>
            <Text  style={{color:colors.FOREGROUND_DARK}}>Terms & Conditions</Text>           
            </View>
            <Image source={Images.next} style={styles.img1}/>
            </View>
            </TouchableOpacity>  
            <TouchableOpacity onPress={()=>Linking.openURL("https://ebonz.in/privacyPolicy")}>
            <View style={styles.view4} >
            <View style={styles.view5}>
            <Text  style={{color:colors.FOREGROUND_DARK}}>Privacy policy</Text>           
            </View>
            <Image source={Images.next} style={styles.img1}/>
            </View>
            </TouchableOpacity>           
...
function mapStateToProps(state) {
  ...
  const connectedHelpandSupoortPage = connect(mapStateToProps)(HelpandSupport);
  export { connectedHelpandSupoortPage as HelpandSupport }; 
...
AppRegistry.registerComponent('HelpandSupport', () => HelpandSupport);
