    ...
    constructor(props) {
     ...
     render() {
        ...
        const { colors, user } = this.props;
         const slides = postdata.images.map((image, i) => {
            return (
...
const connectedSwiperScreenPage = connect(mapStateToProps)(SwiperScreen);
export { connectedSwiperScreenPage as SwiperScreen };
